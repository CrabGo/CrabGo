...
// SysTenantDao is the data access object for the table SysTenant.
...
// SysTenantColumns defines and stores column names for the table SysTenant.
type SysTenantColumns struct {
	...
	HistoryConnectionString string //
	CreateTime              string //
	ContactName             string //
	Email                   string //
	Phone                   string //
...
// sysTenantColumns holds the columns for the table SysTenant.
