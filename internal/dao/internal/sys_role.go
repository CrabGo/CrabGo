...
// SysRoleDao is the data access object for the table SysRole.
...
// SysRoleColumns defines and stores column names for the table SysRole.
...
// sysRoleColumns holds the columns for the table SysRole.
