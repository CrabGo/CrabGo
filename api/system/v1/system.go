...
type QueryCpusReq struct {
	g.Meta `path:"/system/cpu" tags:"system" method:"get" summary:"查询CPU信息"`
}
...
type QueryCpuRateReq struct {
	g.Meta `path:"/system/cpu/use" tags:"system" method:"get" summary:"查询CPU信息"`
}
...
type QueryMemoryReq struct {
	g.Meta `path:"/system/memory" tags:"system" method:"get" summary:"查询内存信息"`
}
...
type QueryDiskReq struct {
	g.Meta `path:"/system/disk" tags:"system" method:"get" summary:"查询磁盘"`
}
...
type QueryHostReq struct {
	g.Meta `path:"/system/host" tags:"system" method:"get" summary:"查询主机"`
}
...
type QueryNetReq struct {
	g.Meta `path:"/system/net" tags:"system" method:"get" summary:"查询主机"`
}
...
type QueryProcessReq struct {
	g.Meta `path:"/system/process" tags:"system" method:"get" summary:"查询进程"`
}
